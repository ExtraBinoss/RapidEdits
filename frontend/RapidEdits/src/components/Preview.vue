...
<template>
    <div
        ref="canvasContainer"
        class="w-full h-full overflow-hidden rounded-lg shadow-2xl shadow-black/50 border border-gray-800 relative"
    >
        <!-- Overlay Controls (Play/Pause could go here) -->
        <div
            class="absolute top-4 left-4 text-xs text-gray-500 font-mono pointer-events-none"
        >
