...
<template>
    ...
    >
        ...
        <div
            v-if="asset.type === MediaType.AUDIO"
            class="w-full h-full flex items-center justify-center bg-gradient-to-br from-canvas-light to-canvas"
        >
        ...
        <!-- Metadata Overlay -->
        <div
            class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-2 pt-6 pointer-events-none"
        >
            <div class="text-xs font-medium text-white truncate mb-0.5">
                {{ asset.name }}
            </div>
