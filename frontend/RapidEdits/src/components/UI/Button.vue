...
const baseClasses =
    "inline-flex items-center justify-center rounded-md font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-primary/50 disabled:opacity-50 disabled:cursor-not-allowed";
...
const sizeClasses = computed(() => {
    ...
    switch (props.size) {
        ...
        case "lg":
            return "px-6 py-2 text-base gap-2.5";
        default:
            return "";
    }
});
