...
<template>
    ...
    >
        ...
        <div
            class="p-4 rounded-full bg-canvas-light border border-canvas-border transition-transform duration-200"
            :class="{ 'scale-110': isDragging }"
        >
            <UploadCloud
                :size="24"
                :class="isDragging ? 'text-brand-primary' : 'text-text-muted'"
            />
        </div>
        ...
        <div class="text-center px-4 pb-4">
            <p
                ...
                :class="{ 'text-brand-accent': isDragging }"
            >
